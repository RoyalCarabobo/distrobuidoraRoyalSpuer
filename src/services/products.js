...
export const ProductService = {
    ...
    /**
     * Obtener los últimos productos para el carrusel
     */
    async getLatestProducts(limit = 5) {
        // Ordenamos por id de forma descendente en caso de que creado_en no esté disponible o dé problemas
        const { data, error } = await supabase
            .from('productos')
            .select('*')
    ...
    /**
     * Obtener TODOS los productos para el catálogo completo
     */
    ...
    /**
     * Suscribirse a cambios en tiempo real en la tabla de productos
     */
    subscribeToLatestProducts(callback) {
